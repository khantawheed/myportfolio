      ...
      <div>
          <div className='flex flex-row justify-between p-5 lg:px-32 px-5 bg-[#081b29] '>
              <div className=' flex flex-row items-center cursor-pointer gap-2'>
                  <h1 className='text-xl font-semibold text-[#ededed]'>my<span className='text-sky-500'>Portfolio</span></h1>
              </div>
              <nav className='hidden md:flex flex-row items-center text-lg font-medium gap-8'>
                  <Link href="#home" duration={500} className='group relative inline-block Cursor-pointer hover:text-sky-500 text-[#ededed]'>
                      Home
