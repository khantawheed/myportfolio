...
const HomeComponent = () => {
  return (
    <div className='min-h-screen bg-stone-200 flex flex-col items-center justify-center gap-8 w-full'>
      <div className='flex flex-col justify-center lg:flex-row lg:justify-center items-center lg:px-32 px-5 gap-5 mt-20 lg:mt-20'>
        <div className='w-full lg:w-2/4 space-y-4'>
          ...
          <div className="flex flex-col lg:flex-row gap-2">
            ...
            <a
              href="#contact"
              className="bg-stone-200 text-sky-950 mt-2 lg:mt-0 py-2 px-4 rounded-full font-semibold text-lg border-2 border-sky-500 transition duration-300 hover:bg-sky-500 hover:text-sky-950"
            >
              Contact Me
            </a>
          </div>
      ...
      <div className="flex items-center justify-center p-3 border-2 border-sky-500 rounded-xl shadow-md bg-white w-full mt-5 lg:w-1/2 lg:mb-10" >
